...
namespace Tween.Editor
{
    ...
    internal class CustomButtonEditor : ButtonEditor
    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            var independentUpdateName = new PropertyField(serializedObject.FindProperty(CustomButtonByInheritance.IndependentUpdateName));
            ...
            root.Add(curveEase);
            root.Add(duration);
            root.Add(independentUpdateName);
